...
2. **Diagram 2** is a _log pipeline_ not a _deployment topology_ — the original ask was "k8s deployment", but the kubernetes/website repo's most-prominent flowchart is this observability one. Still a real, in-use, k8s-official diagram.
