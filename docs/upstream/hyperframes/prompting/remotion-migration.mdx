...
- ❌ _(no request to validate — accepting on "looks right")_
- ✅ `render both and report the SSIM diff`

_Next: [Capstone](/prompting/capstone) — one prompt, one film, every technique in this guide, dissected frame by frame._
