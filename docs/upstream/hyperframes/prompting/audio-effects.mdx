...
If it comes back and the music sounds _hollow_ rather than simply quieter, say so
...
duck under it. A carve pointed at a _group_ picks up whatever is in the group at
the time it runs.
...
**Noise removal.** A gate closes the gaps between phrases; the hiss _underneath_
...
_Next: [Design systems and brand](/prompting/design-systems) — pointing the agent
at a source of brand truth instead of describing a vibe._
