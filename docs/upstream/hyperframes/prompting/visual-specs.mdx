...
glow it had described as sitting _behind_ the rings.
...
A spec tells the builder what each element _is_. A density contract tells it how
...
_Next: [Verified example prompts](/prompting/examples) — the level's gallery,
read with the vocabulary you now have._
