...
<Note>
  The percentages on this page are observed results from this guide's own recreation builds, judged
  frame against frame. Treat them as the shape of the curve, not a guarantee.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="High-fidelity looks" href="/prompting/visual-specs">
    Writing the spec density a recreation needs
  </Card>
  <Card title="Runtimes and 3D" href="/prompting/runtimes-and-3d">
...
_Next: [Rendering and output](/prompting/rendering-and-output) — once the cut is locked, the words that pick the right export._
