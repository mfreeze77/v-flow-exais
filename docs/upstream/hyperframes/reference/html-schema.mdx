...
<section id="result" class="clip" data-start="intro + 0.5" data-duration="3" data-track-index="0">
  Result
</section>
```
...
<template>
  ...
  <div id="root" data-composition-id="pricing" data-width="1920" data-height="1080">
    <!-- scene content -->
  </div>
