...
<Warning>
  The carve belongs on the **music**, never on the voice. It names the tracks it makes room for, the
  same way a sidechain compressor does — you select the track that gets quieter and pick what makes
  it quieter. A voice carved against itself is a bug, not a subtle mix choice.
</Warning>
