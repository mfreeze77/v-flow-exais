...
| How motion is timed   | The renderer pauses your animation and _seeks_ it — jumps it to an exact moment — before capturing each frame | Your code reads the frame number and returns the values for that frame                                                                                |
