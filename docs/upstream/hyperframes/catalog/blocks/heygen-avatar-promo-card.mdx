...
<video
  ...
  src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/heygen-avatar-promo-card.mp4"
...
<InstallCommand
  command="npx hyperframes add heygen-avatar-promo-card"
  item="heygen-avatar-promo-card"
/>
