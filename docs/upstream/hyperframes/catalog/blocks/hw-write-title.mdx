...
<video
  ...
  src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/hw-write-title.mp4"
  poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/hw-write-title.png"
  autoPlay
  muted
  loop
  playsInline
