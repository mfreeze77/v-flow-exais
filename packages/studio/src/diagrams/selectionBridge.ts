...
function bindingFor(sceneId: string, options: ResolveSelectionOptions): SceneSelectionBinding | null {
...
export function resolveSelection(
  ...
  if (relationshipId) {
    if (options.strict && binding && !includes(binding.relationshipIds, relationshipId)) return null;
