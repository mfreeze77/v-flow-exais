...
const CASES = [
  {
    ...
    titleZh: "智能体工具调用",
    descriptionEn:
      "Four consolidated lanes trace a policy-aware agent loop across user interaction, agent runtime, policy and recovery, and tool execution with evidence.",
    descriptionZh:
      "四条整合泳道呈现策略感知的智能体闭环：用户交互、智能体运行时、策略与恢复，以及带证据的工具执行。",
  },
  {
    ...
    titleZh: "生产部署与归属",
    descriptionEn:
      "Regions, private networks, workload owners, state, cross-region replication, audit evidence, and named boundary crossings.",
  ...
  },
  {
    ...
    titleZh: "缓存未命中请求",
    descriptionEn:
      "A time-ordered request path covering authentication, cache fallback, persistence, return traffic, and async tracing.",
  ...
  },
  {
    ...
    titleZh: "研发交付流程",
    descriptionEn:
      "A change moves through reproducible build, blocking gates, human approval, canary verification, communication, and rollback.",
  ...
  },
  {
    ...
    descriptionEn:
      "Detection, incident command, mitigation, stakeholder communication, escalation, rollback, and recovery evidence.",
  ...
  },
  {
    ...
    titleZh: "产品分析数据流",
    descriptionEn:
      "Events move through consent, streaming, PII isolation, warehouse sync, and governed downstream consumers.",
  ...
  },
  {
    ...
    titleZh: "异步任务往返链路",
    descriptionEn:
      "A fast acknowledgement leads into durable queueing, background work, retry, final-state storage, webhook, and polling fallback.",
  ...
  },
  {
    ...
    titleZh: "订单事件流拓扑",
    descriptionEn:
      "Named producers, partitioned topics, consumer groups, idempotent state, dead letters, operator ownership, and controlled replay.",
  ...
  },
  {
    ...
    titleZh: "智能体运行生命周期",
    descriptionEn:
      "Planning, execution, review, human approval, retry, cancellation, and terminal outcomes in one state model.",
  ...
  },
  {
    ...
    titleZh: "部署发布生命周期",
    descriptionEn:
      "The deployment object moves through build, verification, approval, promotion, health pause, rollback, and explicit terminal outcomes.",
  ...
  },
  {
    ...
    titleZh: "三层 Web 应用",
    descriptionEn:
      "A classic AWS web stack with edge delivery, authentication, API services, cache, persistence, and background work.",
...
// oxlint-disable-next-line no-unused-vars -- retained upstream helper
