const REQUIRED_DISCLOSURES = [
  ...
  [
    "Simple Icons collection license",
    "https://github.com/simple-icons/simple-icons/blob/16.28.0/LICENSE.md",
  ],
  [
  ...
  [
    ".NET source",
    "https://github.com/dotnet/brand/blob/c7d0f51b8ec59531332d05fb27a5b758a7a3d689/logo/dotnet-logo.svg",
  ],
  [".NET license", "CC0-1.0"],
  [
    "JavaScript source",
  ...
  [
    "JavaScript license",
    "https://github.com/voodootikigod/logo.js/blob/1544bdeed6d618a6cfe4f0650d04ab8d9cfa76d9/LICENSE",
  ],
  ...
  [
    "general no-endorsement statement",
    "does not imply sponsorship, endorsement, partnership,\nor affiliation with Archify",
  ],
  [
...
const FONT_DISCLOSURES = [
  ...
  [
    "embedded-font treatment",
    "embed the JetBrains Mono variable font\nsubsets served by Google Fonts",
  ],
];
...
export function assertThirdPartyNotices(content, subject = "THIRD_PARTY_NOTICES.md", options) {
  ...
  if (!result.ok) {
    throw new Error(
      `${subject} is incomplete; missing required disclosure: ${result.missing.join(", ")}`,
    );
  }
}

export const THIRD_PARTY_NOTICE_DISCLOSURE_COUNT =
  REQUIRED_DISCLOSURES.length + FONT_DISCLOSURES.length;
